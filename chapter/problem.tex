...
\begin{enumerate}
	...
	\item （单选题，5.0分）命题逻辑演绎的 CP 规则为（\quad）。
	\begin{choices}
		\item 在推演过程中可随便使用前提；
	...
	\item （单选题，5.0分）下列符号串是合式公式的有（\quad）。
	\begin{choices}
	...
	\item （单选题，5.0分）下列哪些公式为永真蕴含式？（\quad）
	\begin{choices}
	...
	\item （多选题，5.0分）$(P \to Q)\to R$ 的合取范式为（\quad）。
	\begin{choices}
	...
	\item （多选题，5.0分）下列各命题中真值为真的命题有（\quad）。
	\begin{choices}
	...
	\item （多选题，5.0分）下列公式中哪些是永真式？（\quad）
	\begin{choices}
		\item $(\neg P \wedge Q)\to (Q\to \neg R)$
		\item $(P \wedge Q)\to P$
		\item $P\to (P\vee Q)$
	...
	\item （多选题，5.0分）$A,B$ 为二合式公式，且 $A \Leftrightarrow B$，则（\quad）。
	\begin{choices}
...
\begin{enumerate}
	\item （单选题，5.0 分）公式 \(A=\exists x(P(x)\to Q(x))\) 的解释 \(I\) 为：个体域 \(D=\{2\}\)，\(P(x):x>3\)，\(Q(x):x=4\)，则 \(A\) 的真值为（\quad）。
	\begin{choices}
		\item 无法判定。
		\item 可满足式；
		\item \(1\)
	...
	\item （单选题，5.0 分）命题“有的人喜欢所有的花”的逻辑符号化为（\quad）。
	...
	\item （单选题，5.0 分）下列等价关系正确的是（\quad）。
	\begin{choices}
	...
	\item （单选题，5.0 分）“人总是要死的”谓词公式表示为（\quad）。
	...
	\item （单选题，5.0 分）公式 \(\forall x\forall y(P(x,y)\vee Q(y,z))\land \exists xP(x,y)\) 换名（\quad）。
	\begin{choices}
	...
	\item （多选题，5.0 分）“没有不犯错误的人”的逻辑符号化为（\quad）。
	...
	\item （多选题，5.0 分）下面蕴涵关系成立的是（\quad）。
	\begin{choices}
	...
	\item （多选题，5.0 分）给定公式 \(\exists xP(x)\to \forall xP(x)\)，当 \(D=\{a,b\}\) 时，解释（\quad）使该公式真值为 \(0\)。
	\begin{choices}
		\item \(P(a)=1,\ P(b)=0\)
		\item \(P(a)=0,\ P(b)=1\)
		\item \(P(a)=1,\ P(b)=1\)
	...
	\item （填空题，0.0 分）命题“对于任意给定的正实数，都存在比它大的实数”令 \(F(x)\)：\(x\) 为实数，\(L(x,y):x>y\)，则命题的逻辑谓词公式为 \underline{\hspace{8cm}}。
	
	\item （填空题，0.0 分）设谓词 \(P(x)\)：\(x\) 是奇数，\(Q(x)\)：\(x\) 是偶数，谓词公式 \(\exists x(P(x)\vee Q(x))\) 在哪个个体域中为真？（\quad）
	
	\((1)\) 自然数 \quad \((2)\) 实数 \quad \((3)\) 复数 \quad \((4)\) \((1)\)--\((3)\) 均成立
	
	\underline{\hspace{8cm}}
	
	\item （填空题，0.0 分）对公式 \((\forall y(P(x,y)\land \exists zQ(x,z))\vee \forall xR(x,y))\) 中自由变元进行代入的公式为：\underline{\hspace{8cm}}。
	
	\item （填空题，0.0 分）若解释 \(I\) 的论域 \(D\) 仅包含一个元素，则 \(\exists xP(x)\to \forall xP(x)\) 在 \(I\) 下真值为 \underline{\hspace{6cm}}。
	
	\item （填空题，0.0 分）设 \(x\) 是谓词合式公式 \(A\) 的一个客体变元，\(A\) 的论域为 \(D\)，\(A(x)\) 关于 \(y\) 是自由的，则 \underline{\hspace{6cm}} 被称为存在量词消去规则，记为 \(ES\)。
	
	\item （填空题，1.0 分）令 \(R(x)\)：\(x\) 是实数，\(Q(x)\)：\(x\) 是有理数。则命题“并非每个实数都是有理数”的符号化表示为（\quad）。
	
	\underline{\hspace{8cm}}
	
	\item （填空题，0.0 分）公式 \(\forall x(A(x)\to B(y,x))\land \exists zC(y,z)\to D(x)\) 中，自由变元是（\quad），约束变元是（\quad）。
	
	\underline{\hspace{8cm}}
	
	\underline{\hspace{8cm}}
	
	\item （填空题，0.0 分）令 \(P(x)\)：\(x\) 是质数，\(E(x)\)：\(x\) 是偶数，\(Q(x)\)：\(x\) 是奇数，\(D(x,y)\)：\(x\) 除尽 \(y\)。则 \(\forall x(E(x)\to \forall y(D(x,y)\to E(y)))\) 的汉语翻译为
	
	\underline{\hspace{12cm}}
	
	\item （填空题，0.0 分）谓词合式公式 \(\forall xP(x)\to \exists xQ(x)\) 的前束范式为 \underline{\hspace{6cm}}。
	
	\item （填空题，0.0 分）设全体域 \(D\) 是正整数集合，确定下列命题的真值：
	...
	\item （填空题，0.0 分）谓词 \(wff\ \forall x\forall y(\exists z(P(x,z)\land P(y,z))\to \exists uQ(x,y,u))\) 的前束范式为
	
	\underline{\hspace{12cm}}
	
	\item （填空题，0.0 分）论域 \(D=\{1,2\}\)，指定谓词 \(P\) 如下：
	...
	\item （填空题，0.0 分）设 \(x\) 是谓词合式公式 \(A\) 的一个客体变元，\(A\) 的论域为 \(D\)，\(A(x)\) 关于 \(y\) 自由的，则 \underline{\hspace{6cm}} 被称为全称量词消去规则，记为 \(US\)。
	
	\item （填空题，0.0 分）\(\forall xF(x)\land \neg(\exists xG(x))\) 的前束范式为 \underline{\hspace{6cm}}。
	
	\item （填空题，0.0 分）谓词公式 \(\forall x(P(x)\vee \exists yR(y))\to Q(x)\) 中量词 \(\forall x\) 的辖域是（\quad）。
	
	\underline{\hspace{8cm}}
	
	\item （填空题，0.0 分）设 \(P(x)\)：\(x\) 是素数，\(E(x)\)：\(x\) 是偶数，\(O(x)\)：\(x\) 是奇数，\(N(x,y)\)：\(x\) 可以整除 \(y\)。则谓词 \(wff\ \forall x(P(x)\to \exists y(O(y)\land N(y,x)))\) 的自然语言是
